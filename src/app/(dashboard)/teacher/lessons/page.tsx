...
import { Video, PlusCircle, Construction } from "lucide-react";
  ...
  return (
    <div className="space-y-6 max-w-5xl">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-[hsl(var(--muted-foreground))] mt-1">
            Create and manage individual lessons across your courses.
          </p>
        </div>
      ...
      <div className="rounded-2xl border border-dashed border-[hsl(var(--border))] p-16 text-center">
        ...
        <h3 className="font-semibold text-lg mb-2">Lessons Manager</h3>
        <p className="text-[hsl(var(--muted-foreground))] max-w-sm mx-auto text-sm">
          Create video lessons, attach resources, and organise content by course section. Coming soon.
        </p>
